...
def main():
    # The agent-codex wrapper invokes the user-level dispatcher and may call
    # this project implementation itself after validation. Do not emit a
    # duplicate project context block for the wrapper's native hook event.
